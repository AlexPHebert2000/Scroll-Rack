...
interface Props { deckName: string; portraitUrl: string | null; }

const ArtBanner = ({ deckName, portraitUrl }: Props) => (
  <Box sx={{
    ...
    <Box sx={{
      position: 'absolute', inset: 0,
      background: 'linear-gradient(to bottom, rgba(30,34,40,0.05) 0%, rgba(30,34,40,0.72) 100%)',
    }} />
    {/* Deck name */}
