        ...
        commits: {
          ...
          include: {
            changes: {
              select: {
                action: true, board: true, cardId: true, count: true, artId: true,
                card: { select: { id: true, name: true, oracleId: true, typeLine: true, cmc: true, manaCost: true, colorIdentity: true, oracleText: true, layout: true, faces: { select: { name: true, typeLine: true, cmc: true }, orderBy: { order: 'asc' } } } },
              },
            },
          },
        },
